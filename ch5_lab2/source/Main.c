...
void recordrespones(int issue, int rating);
void highestraying();
void lowestraying();
...
const char *topics[issues] = { "Global Warming","The Economy","War","Wealth","Education" };
...
void highestraying()
{
	...
	printf("The hightset rated topic was");
...
void lowestraying()
{
	...
	printf("The lowtset rated topic was");
